      ...
      <div class="left-section">
        ...
        <form @submit="updateUserInfo">
          ...
          <div class="form-group">
            ...
            <input type="email" id="emailAdress"  v-model="loginUser.emailAdress" disabled>
          </div>
          <div class="form-group">
            <label for="height">키</label>
            <input type="number" id="height" v-model="loginUser.height" required>
          </div>
          <div class="form-group">
            <label for="weight">몸무게</label>
            <input type="number" id="weight" v-model="loginUser.weight" required>
          </div> 
